...
window.MANIFEST = {
  ...
  story: {
    ...
    fields: [
      ...
      { key: "image_overlay", type: "number",   label: "Overlay (0–1)",   step: 0.05 },
      { key: "headline_size", type: "number",   label: "Headline size (px)", default: 104 },
      { key: "body_size",     type: "number",   label: "Body size (px)",  default: 34 },
    ],
  },
  ...
  quote: {
    ...
    fields: [
      ...
      { key: "body_size",     type: "number",   label: "Body size (px)",  default: 32 },
      { key: "headline_offset_y", type: "number", label: "Headline offset Y (px)", default: 0, step: 10, help: "Nudge headline. Negative = up, positive = down." },
  ...
  "numbered-list": {
    ...
    fields: [
      ...
      { key: "item_size",     type: "number",   label: "Item body size (px)", default: 28 },
  ...
  timeline: {
    ...
    fields: [
      ...
      { key: "item_body_size", type: "number",  label: "Event body (px)", default: 26 },
